...
test.describe('Account Feature — Authenticated', () => {
  ...
  test('SHOPMATE-004a | logged in user sees their username in navbar', async ({ page }) => {
    await page.goto('/');
  ...
  test('SHOPMATE-004b | logged in user can access account details', async ({ page }) => {
  ...
  test('SHOPMATE-004c | logged in user can add product to cart', async ({ page, productsPage, cartPage }) => {
